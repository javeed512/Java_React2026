...
public class CustomerServiceImp implements ICustomerService {
	...
	public static Customer   mapDto2Entity(CustomerDTO customerDTO) {
	...
	public static CustomerDTO  mapEntity2Dto(Customer customer) {
	...
	public Customer addCustomer(CustomerDTO customerDTO) {
		...
		Customer customer =   mapDto2Entity(customerDTO);
	...
	public CustomerDTO getCustomerById(int customerId) {
		...
		CustomerDTO dto =	mapEntity2Dto(customer);
